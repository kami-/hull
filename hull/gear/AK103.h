class AK103 {
    ...
    class RAT : Rifleman {
        weapons[] = {"ACE_AK103", "ACE_RPG7V_PGO7"};
         ruckMagazines[] = {
            {"PG7V", 2},
        };
    };
    ...
    class HMGG : Rifleman {
        weapons[] = {"ACE_AK103", "ACE_DSHKMProxy"};
        magazines[] = {
            {"30Rnd_762x39_AK47", 6},
            {"SmokeShell", 1}
        };
    ...
    class HMGAG : Rifleman {
        weapons[] = {"ACE_AK103", "ACE_DSHKMTripodProxy"};
        magazines[] = {
            {"30Rnd_762x39_AK47",  8},
            {"HandGrenade_East", 1},
            {"SmokeShell", 1}
    ...
    class HATG : Rifleman {
        weapons[] = {"ACE_AK103", "MetisLauncher"};
        magazines[] = {
            {"30Rnd_762x39_AK47", 6},
            {"AT13", 2},
            {"SmokeShell", 1}
    ...
    class Truck : Vehicle {
        ...
        magazines[] = {
            {"30Rnd_762x39_AK47", 50},
            {"ACE_75Rnd_545x39_T_RPK", 30},
            {"ACE_30Rnd_762x39_T_AK47", 25},
            {"30Rnd_545x39_AK", 10},
            {"100Rnd_762x54_PK", 10},
            {"ACE_DSHKM_CSWDM", 8},
            {"mine", 4},
