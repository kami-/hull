class AK74M {
    ...
    class RAT : Rifleman {
        weapons[] = {"ACE_AK74M", "ACE_RPG7V_PGO7"};
        ruckMagazines[] = {
            {"PG7V", 2},
        };
    };
    ...
    class HMGG : Rifleman {
        weapons[] = {"ACE_AK74M", "ACE_DSHKMProxy"};
        magazines[] = {
            {"30Rnd_545x39_AK", 6},
            {"SmokeShell", 1}
        };
    ...
    class HMGAG : Rifleman {
        weapons[] = {"ACE_AK74M", "ACE_DSHKMTripodProxy"};
        magazines[] = {
            {"30Rnd_545x39_AK",  8},
            {"HandGrenade_East", 1},
            {"SmokeShell", 1}
    ...
    class HATG : Rifleman {
        weapons[] = {"ACE_AK74M", "MetisLauncher"};
        magazines[] = {
            {"30Rnd_545x39_AK", 6},
            {"AT13", 2},
            {"SmokeShell", 1}
